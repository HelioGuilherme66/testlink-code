...
/**
 * Modified Sample Testlink Plugin class that registers itself with the system and provides 
 * UI hooks for 
 ...
 * Class DocModPlugin
 */
class DocModPlugin extends TestlinkPlugin
{
  function _construct()
  {
  ...
  {
    $this->name = 'DocMod';
    $this->description = 'DocMod a modification for printing documents';

    $this->version = '1.0';

    $this->author = 'Helio Guilherme';
    $this->contact = 'helio.guilherme@load.digital';
    $this->url = 'http://www.load-interactive.com';
  }
